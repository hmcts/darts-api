...
class FeatureFlagLogApiImplTest {
    ...
    void logArmRpo_ShouldLogMessage_WhenIsEnableArmRpoFeatureFlagLogsEnabled() {
        when(featureFlagLoggingConfig.isArmRpoFeatureFlagLogsEnabled()).thenReturn(true);
    ...
    void logArmRpo_ShouldNotLogMessage_WhenIsEnableArmRpoFeatureFlagLogsDisabled() {
        when(featureFlagLoggingConfig.isArmRpoFeatureFlagLogsEnabled()).thenReturn(false);
        featureFlagLogApi.logArmRpo(LOG_MESSAGE_RPO);
    ...
    void logDetsToArmPush_ShouldLogMessage_WhenIsEnableDetsToArmPushFeatureFlagLogsEnabled() {
        when(featureFlagLoggingConfig.isDetsToArmPushFeatureFlagLogsEnabled()).thenReturn(true);
    ...
    void logArmRpo_ShouldNotLogMessage_WhenIsEnableDetsToArmPushFeatureFlagLogsDisabled() {
        when(featureFlagLoggingConfig.isDetsToArmPushFeatureFlagLogsEnabled()).thenReturn(false);
        featureFlagLogApi.logDetsToArmPush(LOG_MESSAGE_DETS_TO_ARM_PUSH);
    ...
    @Test
    void logDetsToArmPull_ShouldLogMessage_WhenIsEnableArmPullFeatureFlagLogsEnabled() {
        when(featureFlagLoggingConfig.isArmPullFeatureFlagLogsEnabled()).thenReturn(true);
        featureFlagLogApi.logArmPull(LOG_MESSAGE_DETS_TO_ARM_PULL);
    ...
    void logArmRpo_ShouldNotLogMessage_WhenIsEnableDetsToArmPullFeatureFlagLogsDisabled() {
        when(featureFlagLoggingConfig.isArmPullFeatureFlagLogsEnabled()).thenReturn(false);
        featureFlagLogApi.logArmPull(LOG_MESSAGE_DETS_TO_ARM_PULL);
