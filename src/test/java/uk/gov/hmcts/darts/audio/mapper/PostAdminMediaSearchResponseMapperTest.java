...
class PostAdminMediaSearchResponseMapperTest {
    ...
    void multipleEntities() throws IOException {
        ...
        MediaEntity media2 = CommonTestDataUtil.createMedia(media.getHearingList().get(0));
        media2.setStart(media2.getStart().plusMinutes(1));
        MediaEntity media3 = CommonTestDataUtil.createMedia(media.getHearingList().get(0));
