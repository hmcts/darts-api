...
class AdvancedSearchResponseMapperTest {
    ...
    void twoSameCase() throws IOException {
        ...
        hearing1.setId(201);
        hearing1.setJudgeList(CommonTestDataUtil.createJudges(2));
        ...
        hearing2.setId(202);
        hearing2.setJudgeList(CommonTestDataUtil.createJudges(3));
    ...
    void fourWithTwoSameCase() throws IOException {
        ...
        hearing3.setId(203);
        hearing3.setJudgeList(CommonTestDataUtil.createJudges(4));
        ...
        hearing4.setId(204);
        hearing4.setJudgeList(CommonTestDataUtil.createJudges(5));
