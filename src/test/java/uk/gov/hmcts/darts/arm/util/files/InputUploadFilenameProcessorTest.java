...
class InputUploadFilenameProcessorTest {
    ...
    void givenInputUploadFilenameProcessorValidateFilename() {
        String inputUploadFilename = "DARTS/response/12345_111_2_6a374f19a9ce7dc9cc480ea8d4eca0fb_1_iu.rsp";
        ...
        assertEquals("12345_111_2_6a374f19a9ce7dc9cc480ea8d4eca0fb_1_iu.rsp",
                     inputUploadFilenameProcessor.getInputUploadFilename());
        assertEquals(inputUploadFilename, inputUploadFilenameProcessor.getInputUploadFilenameAndPath());
    }
    ...
    @Test
    void givenInputUploadFilenameProcessorWithNullFilenameThrowsException() {
        String inputUploadFilenameProcessor = null;
