...
class GetExtendedSearchesByMatterServiceTest {
    ...
    void setUp() {
        ...
        getExtendedSearchesByMatterService = new GetExtendedSearchesByMatterServiceImpl(armRpoClient, armRpoService, armRpoUtil);
    }
    ...
    void getExtendedSearchesByMatter_ThrowsException_WhenIsSavedFalse() {
        ...
        ArmRpoInProgressException armRpoInProgressException = assertThrows(
            ArmRpoInProgressException.class, () -> getExtendedSearchesByMatterService.getExtendedSearchesByMatter("token", 1, userAccount));
    ...
    void getExtendedSearchesByMatter_ThrowsException_WhenIsSavedNull() {
        ...
        ArmRpoException armRpoException = assertThrows(
            ArmRpoException.class, () -> getExtendedSearchesByMatterService.getExtendedSearchesByMatter("token", 1, userAccount));
