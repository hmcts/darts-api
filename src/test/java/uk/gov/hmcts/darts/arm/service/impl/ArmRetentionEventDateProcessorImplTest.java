...
class ArmRetentionEventDateProcessorImplTest {
    ...
    void calculateEventDates() {
        ...
        when(externalObjectDirectoryRepository.findByExternalLocationTypeAndUpdateRetention(EodHelper.armLocation(), true, Limit.of(10_000))).thenReturn(eods);
        ...
        // then
        verify(externalObjectDirectoryRepository).findByExternalLocationTypeAndUpdateRetention(EodHelper.armLocation(), true, Limit.of(10_000));
