...
class TranscriptionNotificationsTest {
    ...
    void handleNotificationsAndAuditApproved() {
        ...
        // audit
        verify(auditApi).recordForUserAndCase(AUTHORISE_TRANSCRIPTION, approver, caseEntity);
    }
    ...
    void handleNotificationsAndAuditRejected() {
        ...
        assertEquals(actual.getTemplateValues().get(REJECTION_REASON), reason);
        // audit
        verify(auditApi).recordForUserAndCase(REJECT_TRANSCRIPTION, rejecter, caseEntity);
    }
    ...
    void handleNotificationsAndAuditWithTranscriber() {
        ...
        // audit
        verify(auditApi).recordForUserAndCase(ACCEPT_TRANSCRIPTION, transcriber, caseEntity);
    }
    ...
    void handleNotificationsAndAuditComplete() {
        ...
        assertEquals(actual.getUserAccountsToEmail().get(0).getEmailAddress(), requester.getEmailAddress());
        // audit
        verify(auditApi).recordForUserAndCase(COMPLETE_TRANSCRIPTION, transcriber, caseEntity);
    }
    ...
    void handleNotificationsAndAuditApprovedIsNotManual() {
        ...
        verifyNoInteractions(notificationApi);
        // audit
        verify(auditApi).recordForUserAndCase(AUTHORISE_TRANSCRIPTION, transcriber, caseEntity);
    }
    ...
    void handleNotificationsAndAuditRejectedIsNotManual() {
        ...
        verifyNoInteractions(notificationApi);
        // audit
        verify(auditApi).recordForUserAndCase(REJECT_TRANSCRIPTION, transcriber, caseEntity);
    }
