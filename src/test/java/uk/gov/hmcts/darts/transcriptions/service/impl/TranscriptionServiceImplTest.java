...
class TranscriptionServiceImplTest {
    ...
    void saveTranscriptionRequestWithValidValuesAndCourtLogTypeReturnSuccess() {
        ...
        doNothing().when(mockAuditApi).recordForUserAndCase(REQUEST_TRANSCRIPTION, testUser, mockCourtCase);
        ...
        verify(mockAuditApi).recordForUserAndCase(REQUEST_TRANSCRIPTION, testUser, mockCourtCase);
    }
