...
class TemplateIdHelperTest {
    ...
    @Test
    void ok_court_manager_approve_transcript() throws TemplateNotFoundException {
    ...
    @Test
    void ok_requested_audio_is_available() throws TemplateNotFoundException {
    ...
    @Test
    void ok_request_to_transcriber() throws TemplateNotFoundException {
