...
class AudioBeingProcessedFromArchiveQueryImplIntTest extends IntegrationBase {
    ...
    Integer COURTHOUSE_ID = -1000101;
    Integer USER_ACCOUNT_ID = -1000102;
    Integer SECURITY_USER_ID = -1000103;
    Integer COURT_CASE_ID = -1000104;
    Integer COURTROOM_ID = -1000105;
    Integer HEARING_ID = -1000107;
    Integer MEDIA_ID = -1000108;
    Integer MEDIA_ID2 = -1000110;
    Integer MEDIA_ID3 = -1000111;
    Integer MEDIA_ID4 = -1000112;
    Integer MEDIA_ID5 = -1000113;
    Integer MEDIA_ID6 = -1000114;
    Integer MEDIA_ID7 = -1000115;
    Integer MEDIA_ID8 = -1000116;
    Integer MEDIA_ID9 = -1000117;
    Integer MEDIA_ID10 = -1000118;
    Integer MEDIA_ID11 = -1000119;
    Integer MEDIA_ID12 = -1000120;
    Integer MEDIA_ID13 = -1000121;
    Integer MEDIA_ID14 = -1000122;
    Integer MEDIA_ID15 = -1000123;
    Integer MEDIA_ID16 = -1000124;

    Integer EOD_ID = -1000125;
    Integer EOD_ID1 = -1000126;
    Integer EOD_ID2 = -1000127;
    Integer EOD_ID3 = -1000128;
    Integer EOD_ID4 = -1000129;
    Integer EOD_ID5 = -1000130;
    Integer EOD_ID6 = -1000131;

    Integer MEDIA_REQUEST = -1000132;
    ...
    void beforeAll() {
        ...
        jdbcTemplate.update(
            """
                ...
                VALUES
                (${EOD_ID}, ${MEDIA_ID3}, NULL, NULL, 2, 1, 'c15137df-1a2b-4c0d-b309-bc9238330efb', 'wysXTgRikGN6nMB8AJ0JrQ==', NULL, '2024-01-04 15:58:18.120536+00', '2024-01-04 15:58:18.120547+00', -45, -45, NULL, NULL, NULL, NULL, NULL),

                (${EOD_ID1}, ${MEDIA_ID4}, NULL, NULL, 11, 2, 'e9dce141-5f58-4bfd-8660-bce8e0759acb', 'wysXTgRikGN6nMB8AJ0JrQ==', NULL, '2024-01-04 15:59:30.057281+00', '2024-01-04 15:59:30.291683+00', 0, 0, NULL, NULL, NULL, NULL, NULL),

                (${EOD_ID2}, ${MEDIA_ID4}, NULL, NULL, 2, 3, '8b7dff0f-a2e7-4210-8a5e-f216d8c874eb', 'wysXTgRikGN6nMB8AJ0JrQ==', 1, '2024-01-22 16:10:17.427415+00', '2024-01-22 16:10:17.681265+00', 0, 0, NULL, NULL, NULL, NULL, NULL),
                (${EOD_ID3}, ${MEDIA_ID}, NULL, NULL, 3, 3, '71c3e02b-b7d2-4603-be74-e8c39faaf285', 'wysXTgRikGN6nMB8AJ0JrQ==', 1, '2024-01-22 16:10:19.834748+00', '2024-01-22 16:10:20.093688+00', 0, 0, NULL, NULL, NULL, NULL, NULL),
                (${EOD_ID4}, ${MEDIA_ID2}, NULL, NULL, 2, 3, '0dde5ec4-d16d-4940-a923-a73bacd969bb', 'wysXTgRikGN6nMB8AJ0JrQ==', 1, '2024-01-22 16:10:20.882012+00', '2024-01-22 16:10:21.144768+00', 0, 0, NULL, NULL, NULL, NULL, NULL),
                (${EOD_ID5}, ${MEDIA_ID3}, NULL, NULL, 2, 3, '2ba50586-e892-4ff9-a11a-67c38d23837a', 'wysXTgRikGN6nMB8AJ0JrQ==', 1, '2024-01-22 16:10:21.677894+00', '2024-01-22 16:10:21.933572+00', 0, 0, NULL, NULL, NULL, NULL, NULL),

                (${EOD_ID6}, ${MEDIA_ID5}, NULL, NULL, 11, 2, '8b7dff0f-a2e7-4210-8a5e-f216d8c874eb', 'wysXTgRikGN6nMB8AJ0JrQ==', 1, '2024-01-22 16:10:17.427415+00', '2024-01-22 16:10:17.681265+00', 0, 0, NULL, NULL, NULL, NULL, NULL);
                ...
                .replace("${EOD_ID1}", EOD_ID1.toString())
    ...
    void givenAudioBeingProcessedFromArchiveByMediaId_thenReturnResults() {
        ...
        final List<AudioBeingProcessedFromArchiveQueryResult> results = audioBeingProcessedFromArchiveQuery.getResults(HEARING_ID);

        List<AudioBeingProcessedFromArchiveQueryResult> expected = List.of(
            new AudioBeingProcessedFromArchiveQueryResult(MEDIA_ID3, EOD_ID5),
            new AudioBeingProcessedFromArchiveQueryResult(MEDIA_ID2, EOD_ID4)
        );
