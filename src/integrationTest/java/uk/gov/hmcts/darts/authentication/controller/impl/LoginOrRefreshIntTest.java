...
import uk.gov.hmcts.darts.common.config.DartsConfiguration;
import uk.gov.hmcts.darts.common.config.security.SecurityConfig;
...
@WebMvcTest
@Import({DartsConfiguration.class, SecurityConfig.class})
