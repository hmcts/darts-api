...
public class TransformedMediaStub {
    ...
    public TransformedMediaEntity createTransformedMediaEntity(MediaRequestEntity mediaRequestEntity, String filename, OffsetDateTime expiry, OffsetDateTime lastAccessed) {
