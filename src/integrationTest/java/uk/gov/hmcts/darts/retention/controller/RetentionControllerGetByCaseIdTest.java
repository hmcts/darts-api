...
class RetentionControllerGetByCaseIdTest extends IntegrationBase {
    ...
    void testGetRetentionsOk() throws Exception {
        ...
        mockMvc.perform(requestBuilder).andExpect(status().isOk())
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$[0].retention_policy_applied", Matchers.is("DARTS Manual Policy")))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$[1].retention_policy_applied", Matchers.is("DARTS Manual Policy")))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$[2].retention_policy_applied", Matchers.is("DARTS Manual Policy")))
