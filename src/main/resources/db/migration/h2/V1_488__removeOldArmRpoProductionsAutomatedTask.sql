...
VALUES (nextval('aut_seq'), 'RemoveOldArmRpoProductions', 'Remove old ARM RPO productions', '0 22 22 * * ?', true, 50,
...
VALUES (-44, 'system_RemoveOldArmRpoProductions', 'system_RemoveOldArmRpoProductions@hmcts.net', 'system_RemoveOldArmRpoProductions',
