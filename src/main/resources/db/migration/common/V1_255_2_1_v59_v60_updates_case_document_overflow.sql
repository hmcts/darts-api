...
INSERT INTO darts.case_overflow(
	   cas_id, retention_applies_from_ts, end_of_sentence_date_ts, retain_until_ts)
	(select cas_id, retention_applies_from_ts, end_of_sentence_ts, retain_until_ts from darts.court_case);

ALTER TABLE court_case DROP COLUMN retention_applies_from_ts;
ALTER TABLE court_case DROP COLUMN end_of_sentence_ts;
ALTER TABLE court_case DROP COLUMN retain_until_ts;


ALTER TABLE external_object_directory ADD COLUMN cad_id                      INTEGER;-- FK to case_document
ALTER TABLE external_object_directory ADD COLUMN manifest_file               CHARACTER VARYING;
ALTER TABLE external_object_directory ADD COLUMN event_date_ts               TIMESTAMP WITH TIME ZONE;
