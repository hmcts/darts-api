...
ALTER TABLE node_register ALTER COLUMN hostname SET NOT NULL;
ALTER TABLE node_register ALTER COLUMN ip_address SET NOT NULL;
ALTER TABLE node_register ALTER COLUMN mac_address SET NOT NULL;
