insert into event_handler (evh_id, event_type, event_sub_type, event_name, handler, active, created_ts, is_reporting_restriction)
    (select nextval('evh_seq'), '0', '0', 'Bench warrant', 'DartsEventNullHandler', false, current_timestamp, false);

insert into event_handler (evh_id, event_type, event_sub_type, event_name, handler, active, created_ts, is_reporting_restriction)
    (select nextval('evh_seq'), '0', '0', 'Sentencing - Life', 'DartsEventNullHandler', false, current_timestamp, false);
