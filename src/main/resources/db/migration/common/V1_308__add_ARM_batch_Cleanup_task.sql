INSERT INTO darts.automated_task(
    ...
    VALUES (16,'BatchCleanupArmResponseFiles','Delete ARM Batch response files that have been processed','0 9/10 * * * *',true, current_timestamp, 0, current_timestamp, 0, true, 20);
