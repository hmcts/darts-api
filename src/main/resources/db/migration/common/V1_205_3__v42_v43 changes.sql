...
insert into user_account(usr_id,description) values (-1,'Event Processor');
insert into user_account(usr_id,description) values (-2,'DailyList Processor');
insert into user_account(usr_id,description) values (-3,'AddAudio Processor');
insert into user_account(usr_id,description) values (-4,'AddCase Processor');
