...
VALUES (1, 'GET_RECORD_MANAGEMENT_MATTER'),
       ...
       (5, 'GET_MASTERINDEXFIELD_BY_RECORDCLASS_SCHEMA'),
       (6, 'ADD_ASYNC_SEARCH'),
       (7, 'SAVE_BACKGROUND_SEARCH'),
       (8, 'GET_EXTENDED_SEARCHES_BY_MATTER'),
       (9, 'CREATE_EXPORT_BASED_ON_SEARCH_RESULTS_TABLE'),
       (10, 'GET_EXTENDED_PRODUCTIONS_BY_MATTER'),
       (11, 'GET_PRODUCTION_OUTPUT_FILES'),
       (12, 'DOWNLOAD_PRODUCTION'),
       (13, 'REMOVE_PRODUCTION');
