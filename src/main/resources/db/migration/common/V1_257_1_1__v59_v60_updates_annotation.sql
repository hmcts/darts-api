...
ALTER TABLE annotation
  DROP CONSTRAINT annotation_case_fk;
ALTER TABLE annotation
  DROP CONSTRAINT annotation_courtroom_fk;
ALTER TABLE annotation
  DROP CONSTRAINT annotation_hearing_fk;

INSERT INTO darts.hearing_annotation_ae(hea_id, ann_id)
