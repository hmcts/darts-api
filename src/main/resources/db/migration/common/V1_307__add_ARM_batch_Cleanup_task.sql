INSERT INTO darts.automated_task(
    ...
    VALUES (16,'BatchCleanupArmResponseFilesAutomatedTask','Delete ARM response files that have been processed','0 19 22 * * *',true, current_timestamp, 0, current_timestamp, 0, true, 100);
