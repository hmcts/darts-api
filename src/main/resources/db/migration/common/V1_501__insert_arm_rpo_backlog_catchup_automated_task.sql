...
VALUES (nextval('aut_seq'), 'ArmRpoBacklogCatchup', 'ARM RPO backlog catchup job', '0 21,51 7-18 * * *', true, 1000, current_timestamp, 0, current_timestamp, 0, false);
...
VALUES
(-44, 'system_ArmRpoBacklogCatchup', 'system_ArmRpoBacklogCatchup@hmcts.net', 'system_ArmRpoBacklogCatchup', current_timestamp, current_timestamp, 0, 0,
