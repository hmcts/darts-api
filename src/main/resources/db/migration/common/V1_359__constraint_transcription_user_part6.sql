...
update user_account theTable set created_by = 0 where usr_id<>0 AND (created_by is null or not exists (select 1 from user_account ua where ua.usr_id = theTable.created_by));
