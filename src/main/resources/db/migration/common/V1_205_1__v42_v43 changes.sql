...
ALTER TABLE audit_activities
  RENAME column id to aua_id;
ALTER TABLE audit_activities
  RENAME column name to activity_name;
ALTER TABLE audit_activities
  RENAME column description to activity_description;
ALTER TABLE audit_activities
  ADD COLUMN created_ts TIMESTAMP WITH TIME ZONE;
ALTER TABLE audit_activities
  ADD COLUMN created_by INTEGER;
...
ALTER TABLE audit
  RENAME column id to aud_id;
ALTER TABLE audit
  RENAME column case_id to cas_id;
ALTER TABLE audit
  RENAME column audit_activity_id to aua_id;
ALTER TABLE audit
  RENAME column user_id to usr_id;
ALTER TABLE audit
  ADD COLUMN created_by INTEGER;
ALTER TABLE audit
  ADD COLUMN last_modified_ts TIMESTAMP WITH TIME ZONE;
...
ALTER TABLE daily_list
  ADD COLUMN last_modified_by INTEGER;
ALTER TABLE daily_list
  RENAME column daily_list_content to daily_list_content_json;
ALTER TABLE daily_list
  ADD COLUMN daily_list_content_xml CHARACTER VARYING;
