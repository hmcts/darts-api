...
set display_name='Approver',
    display_state= true
WHERE rol_id = 1;

UPDATE security_role
set display_name='Requestor',
    display_state= true
WHERE rol_id = 2;

UPDATE security_role
set display_name='Judge',
    display_state= true
WHERE rol_id = 3;

UPDATE security_role
set display_name='Transcriber',
    display_state= true
WHERE rol_id = 4;

UPDATE security_role
set display_name='Language Shop',
    display_state= true
WHERE rol_id = 5;

UPDATE security_role
set display_name='RCJ Appeals',
    display_state= true
WHERE rol_id = 6;

UPDATE security_role
set display_name='XHIBIT',
    display_state= true
WHERE rol_id = 7;

UPDATE security_role
set display_name='CPP',
    display_state= true
WHERE rol_id = 8;

UPDATE security_role
set display_name='DAR PC',
    display_state= true
WHERE rol_id = 9;

UPDATE security_role
set display_name='Mid Tier',
    display_state= true
WHERE rol_id = 10;
...
ALTER TABLE transcription_type
  ADD COLUMN display_state BOOLEAN;
...
ALTER TABLE transcription_urgency
  ADD COLUMN display_state BOOLEAN DEFAULT TRUE;
...
INSERT INTO transcription_urgency (tru_id, description, display_state)
VALUES (4, '3 working days', true);
INSERT INTO transcription_urgency (tru_id, description, display_state)
VALUES (5, '7 working days', true);
INSERT INTO transcription_urgency (tru_id, description, display_state)
VALUES (6, '12 working days', true);
ALTER TABLE transcription_urgency
  ALTER COLUMN display_state SET NOT NULL;
