...
ALTER TABLE audit
  DROP COLUMN application_server;

update event
set evh_id=1
WHERE evh_id is null;
ALTER TABLE event
  ALTER COLUMN evh_id SET NOT NULL;
...
ALTER TABLE transcription
  DROP CONSTRAINT transcription_case_fk;
ALTER TABLE transcription
  DROP CONSTRAINT transcription_hearing_fk;
ALTER TABLE transcription
  DROP CONSTRAINT unique_transcription;
