...
--Security
ALTER TABLE security_group DROP COLUMN r_dm_group_s_object_id;
ALTER TABLE security_group DROP COLUMN r_modify_date;
ALTER TABLE security_group ADD COLUMN display_name                     CHARACTER VARYING;
ALTER TABLE security_group ADD COLUMN dm_group_s_object_id             CHARACTER VARYING(16);
