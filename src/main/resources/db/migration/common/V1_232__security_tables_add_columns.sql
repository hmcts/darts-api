ALTER TABLE security_group ADD COLUMN global_access boolean NOT NULL DEFAULT FALSE;
ALTER TABLE security_group ADD COLUMN display_state boolean NOT NULL DEFAULT TRUE;
