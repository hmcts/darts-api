ALTER TABLE event ADD COLUMN is_log_entry  BOOLEAN    NOT NULL  default false;
...
ALTER TABLE automated_task ADD COLUMN task_enabled  BOOLEAN    NOT NULL default true;

ALTER TABLE report DROP COLUMN superseded;
