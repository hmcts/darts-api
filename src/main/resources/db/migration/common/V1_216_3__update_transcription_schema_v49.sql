...
SET description='Sentencing remarks',
    created_by=0,
    last_modified_by=0,
    created_ts=now(),
...
WHERE trt_id = 1;
UPDATE transcription_type
SET description='Summing up (including verdict)',
    created_by=0,
    last_modified_by=0,
    created_ts=now(),
    last_modified_ts=now()
...
WHERE trt_id = 3;
UPDATE transcription_type
SET description='Argument and submission of ruling',
    created_by=0,
    last_modified_by=0,
    created_ts=now(),
    last_modified_ts=now()
...
WHERE trt_id = 6;
UPDATE transcription_type
SET description='Proceedings after verdict',
    created_by=0,
    last_modified_by=0,
    created_ts=now(),
    last_modified_ts=now()
WHERE trt_id = 7;
UPDATE transcription_type
SET description='Prosecution opening of facts',
    created_by=0,
    last_modified_by=0,
    created_ts=now(),
    last_modified_ts=now()
WHERE trt_id = 8;
UPDATE transcription_type
SET description='Specified Times',
    created_by=0,
    last_modified_by=0,
    created_ts=now(),
    last_modified_ts=now()
