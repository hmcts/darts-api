...
INSERT INTO darts.retention_policy_type
(rpt_id, fixed_policy_key, policy_name, duration, policy_start_ts, retention_policy_object_id, created_ts, created_by, last_modified_ts, last_modified_by)
VALUES (5, 3, 'DARTS Custodial Policy', '7 years or length of sentence (passed into the case total sentence field), whichever is greater',
        '2024-01-01 00:00:00', '081707589800c90b', current_timestamp, 0, current_timestamp, 0);
INSERT INTO darts.retention_policy_type
(rpt_id, fixed_policy_key, policy_name, duration, policy_start_ts, retention_policy_object_id, created_ts, created_by, last_modified_ts, last_modified_by)
