...
ALTER TABLE transcription DROP COLUMN requested_by;
ALTER TABLE transcription DROP COLUMN approved_by;
ALTER TABLE transcription DROP COLUMN approved_on_ts;
ALTER TABLE transcription DROP COLUMN transcribed_by;

ALTER TABLE transcription ADD COLUMN trs_id INTEGER NOT NULL;
