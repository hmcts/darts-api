...
VALUES (nextVal('cth_seq'), 'BURNLEY CC SITTING AT BURNLEY MC', 'Burnley CC Sitting at Burnley MC', '/Area 2/Burnley CC Sitting at Burnley MC', '0b1707589ae8caf3', 0, current_timestamp, 0, current_timestamp);
...
VALUES (nextval('grp_seq'), 2, 'moj_ch_burnley_cc_at_bu_staff', 'Burnley CC Sitting at Burnley MC Requester', false, true, false, '121707588000d100', '0b1707589ae8caf3_staff', 0, current_timestamp, 0, current_timestamp);
...
INSERT INTO security_group_aud (grp_id, group_name, display_name, description, rev, revtype)
    ...
    FROM security_group
    WHERE group_name = 'moj_ch_burnley_cc_at_bu_staff';


INSERT INTO security_group (grp_id, rol_id, group_name, display_name, global_access, display_state, use_interpreter, dm_group_s_object_id, group_display_name, created_by, created_ts, last_modified_by, last_modified_ts)
VALUES (nextval('grp_seq'), 3, 'moj_ch_burnley_cc_at_bu_appr', 'Burnley CC Sitting at Burnley MC Approver', false, true, false, '121707588000d101', '0b1707589ae8caf3_appr', 0, current_timestamp, 0, current_timestamp);
