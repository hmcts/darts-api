...
ALTER TABLE transient_object_directory
  ADD PRIMARY KEY USING INDEX transient_object_directory_pk;

CREATE UNIQUE INDEX urgency_pk ON urgency (urg_id);
ALTER TABLE urgency
  ADD PRIMARY KEY USING INDEX urgency_pk;

CREATE UNIQUE INDEX user_account_pk ON user_account (usr_id);
ALTER TABLE user_account
  ADD PRIMARY KEY USING INDEX user_account_pk;
