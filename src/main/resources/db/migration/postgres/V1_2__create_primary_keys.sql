...
CREATE UNIQUE INDEX defence_name_pk ON defence_name(dfc_id);
ALTER TABLE defence_name            ADD PRIMARY KEY USING INDEX defence_name_pk;

CREATE UNIQUE INDEX defendant_name_pk ON defendant_name(dfd_id);
...
CREATE UNIQUE INDEX judge_name_pk ON judge_name(jud_id);
...
CREATE UNIQUE INDEX prosecutor_name_pk ON prosecutor_name(prn_id);
