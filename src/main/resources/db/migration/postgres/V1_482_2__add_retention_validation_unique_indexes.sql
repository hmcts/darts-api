CREATE UNIQUE INDEX IF NOT EXISTS wk_case_best_values_p1_pk ON wk_case_best_values_p1(cas_id);
ALTER TABLE IF EXISTS wk_case_best_values_p1 ADD PRIMARY KEY USING INDEX wk_case_best_values_p1_pk;

CREATE UNIQUE INDEX IF NOT EXISTS wk_case_best_values_post_p1_pk ON wk_case_best_values_post_p1(cas_id);
ALTER TABLE IF EXISTS wk_case_best_values_post_p1 ADD PRIMARY KEY USING INDEX wk_case_best_values_post_p1_pk;

CREATE UNIQUE INDEX IF NOT EXISTS wk_case_activity_data_pk ON wk_case_activity_data(cas_id,closed_date_type);
