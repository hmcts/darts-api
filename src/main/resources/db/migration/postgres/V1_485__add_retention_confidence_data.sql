...
-- CC_DETS
ALTER TABLE IF EXISTS cc_dets RENAME COLUMN latest_event_by_event_ts_ts TO latest_event_by_event_ts;
ALTER TABLE IF EXISTS cc_dets RENAME COLUMN cas_retention_fixed TO case_retention_fixed;
