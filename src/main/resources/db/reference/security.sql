...
ALTER TABLE security_group
  ADD PRIMARY KEY USING INDEX security_group_pk;
...
ALTER TABLE security_permission
  ADD PRIMARY KEY USING INDEX security_permission_pk;
...
ALTER TABLE security_role_permission_ae
  ADD PRIMARY KEY USING INDEX security_role_permission_ae_pk;
...
ALTER TABLE security_group_courthouse_ae
  ADD PRIMARY KEY USING INDEX security_group_courthouse_ae_pk;
...
ALTER TABLE security_group
  ADD CONSTRAINT security_group_modified_by_fk
