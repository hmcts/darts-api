...
COMMENT ON COLUMN arm_automated_task.aat_id
    IS 'primary key of arm_automation_task';
...
ALTER TABLE arm_automated_task
    ADD CONSTRAINT arm_automated_task_automated_task_fk
        FOREIGN KEY (aut_id) REFERENCES automation_task(aut_id);
...
GRANT SELECT,INSERT,UPDATE,DELETE ON arm_automation_task TO darts_user;
