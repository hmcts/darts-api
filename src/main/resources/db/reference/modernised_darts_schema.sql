...
ALTER TABLE audit_activity
  ADD PRIMARY KEY USING INDEX audit_activity_pk;
...
ALTER TABLE hearing_annotation_ae
  ADD PRIMARY KEY USING INDEX hearing_annotation_ae_pk;
...
ALTER TABLE node_register
  ADD PRIMARY KEY USING INDEX node_register_pk;
...
ALTER TABLE object_record_status
  ADD PRIMARY KEY USING INDEX object_record_status_pk;
...
-- set defaults
ALTER TABLE node_register
  ALTER COLUMN node_type SET DEFAULT 'DAR';
