...
COMMENT ON COLUMN court_case.defendant_list
IS 'directly sourced from moj_case_r';

COMMENT ON COLUMN court_case.prosecutor_list
IS 'directly sourced from moj_case_r';

COMMENT ON COLUMN court_case.defence_list
IS 'directly sourced from moj_case_r';
...
COMMENT ON COLUMN hearing.judge_list
IS 'directly sourced from moj_case_r';
...
COMMENT ON COLUMN hearing_event_ae.hev_id
...
COMMENT ON COLUMN hearing_media_ae.hma_id
...
CREATE TABLE reporting_restrictions
(rer_id                     INTEGER                  NOT NULL
,rer_description            CHARACTER VARYING
) TABLESPACE darts_tables;

COMMENT ON COLUMN reporting_restrictions.rer_id
IS 'primary key of reporting_restrictions';

COMMENT ON COLUMN reporting_restrictions.rer_description
...
CREATE UNIQUE INDEX hearing_event_ae_pk ON hearing_event_ae(hev_id) TABLESPACE darts_indexes;
ALTER TABLE hearing_event_ae        ADD PRIMARY KEY USING INDEX hearing_event_ae_pk;

CREATE UNIQUE INDEX hearing_media_ae_pk ON hearing_media_ae(hma_id) TABLESPACE darts_indexes;
...
CREATE UNIQUE INDEX reporting_restrictons_pk ON reporting_restrictions(rer_id) TABLESPACE darts_indexes;
ALTER TABLE reporting_restrictions  ADD PRIMARY KEY USING INDEX reporting_restrictons_pk;
...
CREATE SEQUENCE hev_seq CACHE 20;
CREATE SEQUENCE hma_seq CACHE 20;
...
FOREIGN KEY (rer_id) REFERENCES reporting_restrictions(rer_id);
...
GRANT SELECT,INSERT,UPDATE,DELETE ON reporting_restrictions TO darts_user;
...
GRANT SELECT,UPDATE ON  hev_seq TO darts_user;
GRANT SELECT,UPDATE ON  hma_seq TO darts_user;
...
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES  (1,'Section 39 of the Children and Young Persons Act 1999');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES  (2,'An order made under s45 of the Youth Justice and Criminal Evidence Act 1999');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES  (3,'Section 4(2) of the Contempt of Court Act 1981');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES  (4,'Restrictions Lifted');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES  (5,'Section 2 of the Sexual Offenders (Amendment) Act 1992');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES  (6,'Section 11 of the Contempt of Court Act 1981');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES  (7,'An order made under s45a of the Youth Justice and Criminal Evidence Act 1999');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES  (8,'An order made under s46 of the Youth Justice and Criminal Evidence Act 1999');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES  (9,'Section 4 of the Sexual Offenders (Amendment) Act 1976');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES (10,'Judge directed on reporting restrictions');
INSERT INTO reporting_restrictions (rer_id,rer_description) VALUES (11,'An order made under s49 of the Children and Young Persons Act 1933');
