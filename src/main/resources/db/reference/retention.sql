...
(cas_id                        INTEGER
,case_total_sentence           CHARACTER VARYING
,manual_retention_override     BOOLEAN
,retention_fixed_rpt_id        INTEGER
,retention_audit_rpt_id        INTEGER
,retention_retainer_rpt_id     INTEGER
,actual_case_closed_flag       BOOLEAN
...
,closure_method                CHARACTER VARYING
