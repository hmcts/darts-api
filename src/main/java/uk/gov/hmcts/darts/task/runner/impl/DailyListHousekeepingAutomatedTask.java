...
@Slf4j
@Component
public class DailyListHousekeepingAutomatedTask
    extends AbstractLockableAutomatedTask<DailyListHousekeepingAutomatedTaskConfig>
    implements AutoloadingManualTask {

    private final DailyListService dailyListService;

    @Autowired
    public DailyListHousekeepingAutomatedTask(AutomatedTaskRepository automatedTaskRepository,
                                              DailyListHousekeepingAutomatedTaskConfig automatedTaskConfigurationProperties,
