...
public enum AutomatedTaskName {
    ...
    ARM_RPO_POLLING_TASK_NAME("ArmRpoPolling", "${darts.automated.task.process-e2e-arm-rpo-pending.process-e2e-arm-rpo:false}"),
    ARM_RPO_REPLAY_TASK_NAME("ArmRpoReplay", "${darts.automated.task.process-e2e-arm-rpo-pending.process-e2e-arm-rpo:false}"),
