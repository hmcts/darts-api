...
public class ViqHeader {
    ...
    private static final int DAY_POSITION = 39;
    private static final int MONTH_POSITION = 40;
    private static final int MINUTE_POSITION = 41;
    private static final int HOUR_POSITION = 42;
    private static final int SECONDS_POSITION = 44;
    ...
    public ViqHeader(Instant startTime) {

        viqHeader = new byte[VIQ_HEADER_SIZE];
        viqHeader[DAY_POSITION] = (byte) startTime.atOffset(ZoneOffset.UTC).getDayOfMonth();
        viqHeader[MONTH_POSITION] = (byte) (startTime.atOffset(ZoneOffset.UTC).getMonthValue() + 1);
        viqHeader[MINUTE_POSITION] = (byte) startTime.atOffset(ZoneOffset.UTC).getMinute();
        viqHeader[HOUR_POSITION] = (byte) startTime.atOffset(ZoneOffset.UTC).getHour();
        viqHeader[SECONDS_POSITION] = (byte) startTime.atOffset(ZoneOffset.UTC).getSecond();
