...
public interface CourthouseService {
    ...
    CourthouseEntity amendCourthouseById(uk.gov.hmcts.darts.courthouses.model.Courthouse courthouse, Integer id);

    CourthouseEntity getCourtHouseById(Integer id);

    List<CourthouseEntity> getAllCourthouses();

    CourthouseEntity addCourtHouse(uk.gov.hmcts.darts.courthouses.model.Courthouse courthouse);
