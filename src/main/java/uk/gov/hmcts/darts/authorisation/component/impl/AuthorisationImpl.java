...
public class AuthorisationImpl implements Authorisation {
    ...
    @Override
    public void authoriseByMediaRequestId(Integer mediaRequestId) {
        try {
    ...
    @Override
    public void authoriseByMediaId(Integer mediaId) {
        try {
    ...
    @Override
    public void authoriseByTranscriptionId(Integer transcriptionId) {
        try {
