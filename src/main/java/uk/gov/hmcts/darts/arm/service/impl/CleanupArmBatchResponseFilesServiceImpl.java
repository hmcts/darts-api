...
import uk.gov.hmcts.darts.arm.service.CleanupArmBatchResponseFilesService;
...
@Slf4j
public class CleanupArmBatchResponseFilesServiceImpl implements CleanupArmBatchResponseFilesService {
    ...
    @Override
    public void cleanupBatchResponseFiles() {
