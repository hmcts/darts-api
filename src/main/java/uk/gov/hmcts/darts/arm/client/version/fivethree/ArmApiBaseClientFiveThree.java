...
public interface ArmApiBaseClientFiveThree {
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.update-metadata-path}",
    ...
    @GetMapping("${darts.storage.arm-api.version5-3.api.download-data-path}")
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.get-record-management-matter-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.get-storage-accounts-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.get-master-index-field-by-record-class-schema-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.get-profile-entitlements-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.add-async-search-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ArmAsyncSearchResponse addAsyncSearch(@RequestHeader(AUTHORIZATION) String bearerAuth, @RequestBody String body);

    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.get-indexes-by-matter-id-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.save-background-search-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.get-extended-searches-by-matter-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.get-production-output-files-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.create-export-based-on-search-results-table-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.get-extended-productions-by-matter}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE
    )
    ...
    @GetMapping(value = "${darts.storage.arm-api.version5-3.api.download-production-path}",
    ...
    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.available-entitlement-profiles-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE)
    AvailableEntitlementProfile availableEntitlementProfiles(@RequestHeader(AUTHORIZATION) String bearerAuth,
                                                             @RequestBody EmptyRpoRequest emptyRpoRequest);

    @PostMapping(value = "${darts.storage.arm-api.version5-3.api.select-entitlement-profile-path}",
        consumes = APPLICATION_JSON_VALUE,
        produces = APPLICATION_JSON_VALUE)
