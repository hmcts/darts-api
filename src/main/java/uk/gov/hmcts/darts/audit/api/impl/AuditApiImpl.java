...
public class AuditApiImpl implements AuditApi {
    ...
    @Override
    public void recordForUserAndCase(AuditActivity activity, UserAccountEntity userAccountEntity, CourtCaseEntity courtCase) {
    ...
    public void recordAll(AuditActivityProvider auditActivityProvider) {
        auditActivityProvider.getAuditActivities()
            .forEach(auditActivity -> recordForUserAndCase(auditActivity, authorisationApi.getCurrentUser(), null));
    }
