...
public class NotificationController implements NotificationApi {
    ...
    /**
     * POST /notification/create : Creates a notification entry in the notification table.
     * description
     *
     * @param eventId Unique ID that represents the Template to be used. (required)
     * @param caseId The Case Number (required)
     * @param emailAddresses Comma separated list of email addresses to send the notification to. (required)
     * @param templateValues A Json string representing any extra template parameters that might be needed. (optional)
