    ...
    public void handleNotificationsAndAudit(UserAccountEntity userAccountEntity,
        ...
        switch (newStatusEnum) {
            ...
            case REJECTED -> {
                ...
                auditApi.recordForUserAndCase(REJECT_TRANSCRIPTION, userAccountEntity, courtCaseEntity);
            }
            case WITH_TRANSCRIBER -> auditApi.recordForUserAndCase(ACCEPT_TRANSCRIPTION, userAccountEntity, courtCaseEntity);
            case COMPLETE -> {
                if (Boolean.TRUE.equals(transcriptionEntity.getIsManualTranscription())) {
                    notifyRequestor(transcriptionEntity, TRANSCRIPTION_AVAILABLE.toString());
                }
                auditApi.recordForUserAndCase(COMPLETE_TRANSCRIPTION, userAccountEntity, courtCaseEntity);
            }
            default -> {
