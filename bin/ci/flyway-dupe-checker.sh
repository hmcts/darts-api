...
flyway_script_count=$(find ./src/main/resources/db/migration/common -type f | wc -l | jq -r)
echo "Flyway migration script count: $flyway_script_count"

readarray -t unique_numbers < <(find ./src/main/resources/db/migration/common -type f | awk -F '__' '{print $1}' | sort | uniq -c)
