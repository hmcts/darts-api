...
echo "*** WARNING: This script will destroy your local DARTS API database and restore it from staging. ***"
...
RESTORE_LOG_FILE="/tmp/darts-api-local-restore.log"
RESTORE_OUTPUT="/tmp/darts-api-local-stdout.log"
